...
const CHANGELOG: ChangelogItem[] = [
...

  {
    ...
    highlights: [
      ...
      {
        title:
          "Starter Pro documentation expanded for production-shaped validation",
        items: [
...

  {
    ...
    highlights: [
      {
        title: "Starter Pro product surfaces are more production-ready",
        items: [
...

  {
    ...
    highlights: [
      ...
      {
        title: "npm Trusted Publishing and release infrastructure hardened",
        items: [
  ...
  },
  {
    ...
    highlights: [
      {
        title: "NA-AI Landing is now part of the PyColors product line",
        items: [
      ...
      {
        title: "Marketing pages now explain the product ladder better",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Pricing and upgrade surfaces are more conversion-focused",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Starter Free docs now explain the evaluation path better",
        items: [
      ...
      {
        title: "Design system, UI, guides, and patterns docs expanded",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Starter Pro docs now explain value and delivery better",
        items: [
      ...
      {
        title: "UI, patterns, guides, and design system docs were clarified",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Checkout and post-checkout flow are now product-shaped",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Pricing, billing docs, and backend narrative are clearer",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Safer auth configuration and account conflict handling",
        items: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Trust surface: npm badges + safer external SVG support",
        items: [
  ...
  {
    version: "v1.2.0",
    title: "Ecosystem public launch: Tokens + ESLint + Release Engine",
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        items: ["Updated favicon assets for stronger branding consistency."],
      },
      {
        title: "Refactoring",
        items: [
