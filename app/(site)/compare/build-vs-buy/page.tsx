      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12">
          <MarketingSectionShell
            ...
            className="scroll-mt-28 border-t border-border-subtle"
          >
          ...
          >
            ...
            <p className="mt-4 text-xs leading-6 text-muted-foreground">
              This comparison is directional, not a guarantee. Starter Pro
              reduces repeated foundation work, but every serious product still
              needs review, customization, testing, and maintenance.
            </p>
          </MarketingSectionShell>
          ...
          <section className="border-t border-border-subtle py-12">
              ...
              <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                <div className="space-y-3">
                  ...
                  <p className="max-w-2xl text-sm leading-7 text-muted-foreground">
                    ...
                    protected routes, database foundations, and product surfaces
                    already connected enough to evaluate, adapt, and ship from.
                  </p>
                </div>
            ...
            <div className="mt-6 flex items-center gap-2 text-xs leading-6 text-muted-foreground">
              ...
              <span>
                Best next step: inspect the Starter Pro scope, then decide
                whether the saved setup work is worth the adaptation work for
                your product.
              </span>
            </div>
          </section>
