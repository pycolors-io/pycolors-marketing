            ...
            <header className="flex flex-col items-center gap-6 text-center">
              ...
              <div className="space-y-4">
                ...
                <p className="mx-auto max-w-2xl text-balance text-sm text-muted-foreground sm:text-base">
                  ...
                  production-shaped screens fast. Upgrade to PRO when
                  you want the critical wiring handled: auth, billing,
                  backend foundations, and deployment guidance.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-3xl text-sm leading-relaxed text-muted-foreground">
                      ...
                      exists to remove the most expensive part of
                      shipping a real SaaS: authentication, billing,
                      backend contracts, and launch readiness. Starter
                      Free proves the product surface. PRO upgrades
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <Card className="p-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      ...
                      surfaces, settings, billing entrypoints, and
                      admin UI to validate your product structure
                      before touching backend infrastructure.
                    </p>
                ...
                <Card className="p-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Upgrade when auth, billing, backend contracts,
                      and launch readiness become the bottleneck. PRO
                      exists to remove glue code, repeated setup, and
            ...
            <section className="py-8 sm:py-10">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <FaqCard
                  ...
                  answer={
                    <>
                      Because the offer must be clear before the build
                      is complete. This page defines the promise,
                      pricing direction, and upgrade path.
                    </>
                  }
                />
                ...
                <FaqCard
                  ...
                  answer={
                    <>
                      ...
                      operational setup yourself. Free is ideal when
                      you want speed and flexibility first.
                    </>
                  }
                />
                ...
                <FaqCard
                  ...
                  answer={
                    <>
                      The UI direction stays consistent. What changes
                      is the depth of wiring: auth, billing, backend
                ...
                <FaqCard
                  ...
                  answer={
                    <>
                      ...
                      screens and UX contracts, then move to a
                      stronger business layer underneath.
                    </>
                  }
                />
              ...
              <Card className="p-6 sm:p-7">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use Starter Free to validate your SaaS UX now.
                      Join PRO if you want a faster path to auth,
                      billing, backend foundations, and launch-ready
                      structure.
                    </p>
