...
description: From product idea to real SaaS. Launch a template, validate your SaaS surface, wire auth, billing, PWA-ready foundations, and ship with production-shaped systems.
full: false
hero: false
...
5. add app-like production foundations
6. launch with stronger confidence
7. reduce the distance between product work and revenue
...
<Callout title="The PyColors path">
  Templates launch your offer. Starter Free helps you validate. Starter Pro helps you launch, monetize, package, and reduce the infrastructure work that delays revenue.
</Callout>
...
<DocsLinks
  ...
  items={[
    ...
    },
    {
      ...
      description:
        'Launch with real auth, billing, backend foundations, protected routes, PWA-ready app foundations, and delivery.',
      icon: Rocket,
      tone: 'primary',
      badge: 'Pro',
    },
  ...
  items={[
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Move to Starter Pro when auth, billing, protected routes, backend persistence, secure delivery, and app-ready foundations become the work slowing launch.
          </p>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Validate the production checklist, confirm real users, real payments, installable app behavior, and production infrastructure, then ship the first version of your SaaS.
          </p>
...
<DocsLinks
  ...
  items={[
    ...
    },
    {
      ...
      description:
        'Decide when buying Starter Pro is higher leverage than rebuilding auth, billing, backend, and app foundations.',
      icon: Rocket,
      tone: 'primary',
    },
    {
