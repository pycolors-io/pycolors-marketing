...
<DocsUpgradeCTA
  title="Validate the foundation. Then build the product."
  description="Starter Pro gives you the launch baseline so your first serious work can be product work, not infrastructure work."
