...
<Callout type="info" title="Local-only fixtures">
  These accounts are development fixtures intended only for local and controlled staging environments.
  Never reuse these credentials in production systems.
</Callout>
