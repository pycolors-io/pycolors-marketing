  ...
  items={[
    {
      ...
      description: (
        <>
          <p>
            Labels should stay explicit, predictable, and easy to scan.
          </p>

          <div className="mt-3 flex flex-wrap gap-2">
            <Badge variant="outline">Password</Badge>
            <Badge variant="outline">Current password</Badge>
            <Badge variant="outline">New password</Badge>
            <Badge variant="outline">Confirm password</Badge>
          </div>
        </>
      ),
    },
    {
      value: 'Helper text',
      title: 'Helper text examples',
      icon: Info,
      description: (
        <>
          <p>
            Use helper text to explain expectations before validation fails.
          </p>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Error messages should explain the problem clearly and stay actionable.
          </p>

          <div className="mt-3 space-y-2">
            <div className="rounded-[5px] border border-destructive/20 bg-destructive/5 px-3 py-2 text-sm text-destructive">
