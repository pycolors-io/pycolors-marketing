...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <a href="/docs/patterns/layout" className="group flex items-start justify-between gap-6 rounded-2xl border border-border/60 bg-card p-5 no-underline transition hover:border-foreground/20 hover:bg-muted/30">
    <div>
      <div className="text-sm font-medium text-foreground">Layout pattern</div>
      <div className="mt-2 text-sm leading-6 text-muted-foreground">
