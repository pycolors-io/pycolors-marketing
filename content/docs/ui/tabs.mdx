  ...
  items={[
    {
      ...
      description: (
        <>
          <p>
            Use tabs to separate stable configuration areas inside settings surfaces.
          </p>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Billing surfaces often group related financial and subscription information.
          </p>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Dashboard tabs help organize operational views without creating route overload.
          </p>
