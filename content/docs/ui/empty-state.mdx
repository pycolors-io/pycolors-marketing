  ...
  items={[
    {
      ...
      description: (
        <>
          <p>
            Use first-run empty states when the user has not created any data yet.
          </p>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Explain that filters or search constraints removed the current results.
          </p>
    ...
    {
      value: 'Configured later',
      title: 'No metrics available',
      icon: BarChart3,
      description: (
        <>
          <p>
            Use delayed-state messaging when data depends on future activity or integrations.
          </p>
