...
<DocsLinks
  ...
  items={[
    ...
    },
    {
      ...
      description: "Apply accessibility responsibilities when composing public primitives.",
    },
    {
      title: "Why PyColors UI",
      href: "/docs/ui/why-pycolors-ui",
      description: "Connect the design-system rules to the public component philosophy.",
    },
  ]}
/>
