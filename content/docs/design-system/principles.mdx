...
import { Accessibility, Layers3, Palette, Sparkles } from "lucide-react";
...
<Callout title="Review question">
  If the same decision must be repeated in two places, first ask whether the
  system is missing an owner for it.
</Callout>
  ...
  items={[
    {
      ...
      icon: Layers3,
      description:
        "See how repeated visual decisions become shared foundations.",
    },
    {
      title: "Colors",
      ...
      icon: Palette,
      description:
        "Use semantic roles for surfaces, text, borders, and states.",
    },
    {
