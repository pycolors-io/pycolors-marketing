  ...
  items={[
    {
      ...
      items: [
        ...
        'pricing, FAQ, integrations, testimonials, and contact sections',
        'dark/light mode and SEO baseline',
        'powered by PyColors UI and PyColors Tokens',
      ],
      cta: 'Explore template →',
    },
    {
      eyebrow: 'Validate a product',
