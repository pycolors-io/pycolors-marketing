...
import { AlertCircle, CheckCircle, Component, FormInput, Layers3, PanelsTopLeft, Rocket, ShieldCheck, Sparkles } from "lucide-react";
  ...
  items={[
    {
      title: 'Composition',
      description:
        'Learn how primitives combine into real product surfaces, layouts, and reusable SaaS flows.',
      icon: Layers3,
    },
    {
      title: 'Behavior',
      description:
        'Understand async states, validation, interactions, overlays, and user feedback patterns.',
      icon: Sparkles,
    },
    {
      title: 'Consistency',
      description:
        'Keep UX, semantics, spacing, and product behavior stable as the system grows.',
      icon: ShieldCheck,
    },
  ]}
/>
