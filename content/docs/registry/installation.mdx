...
<Callout title="Public transport verification is still required">
  ...
  credential-free check of the Marketing mirror and its base dependency has
  been recorded. Local artifact tests do not establish that public availability.
  Until then, [copy the Block from its documentation](/docs/blocks/feedback/empty-state-panel#copy-source)
  and follow [UI installation](/docs/ui/installation).
</Callout>
