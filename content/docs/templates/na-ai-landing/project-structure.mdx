  ...
  items={[
    {
      ...
      title: 'Data layer',
      description:
        'Owns content, lists, pricing values, nav labels, FAQ items, testimonials, and section configuration.',
    },
    {
      value: 'Sections',
      title: 'Section layer',
      description:
        'Renders the product blocks that compose the landing page experience.',
    },
    {
      value: 'Layout',
      title: 'Layout layer',
      description:
        'Owns navbar, footer, section framing, theme provider, and global structure.',
    },
    {
      value: 'UI',
      title: 'UI primitives',
