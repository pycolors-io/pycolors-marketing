  ...
  items={[
      ...
      description: (
        <>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Badge variant="outline">OAuth providers</Badge>
            <Badge variant="outline">Session security</Badge>
    ...
    },
    {
      ...
      description: (
        <>
          <p>
            Database configuration becomes required when mocked data transitions into persisted product state.
          </p>

          <div className="mt-4 flex flex-wrap gap-2">
            <Badge variant="outline">DATABASE_URL</Badge>
            <Badge variant="outline">Prisma</Badge>
            <Badge variant="outline">Persistence</Badge>
            <Badge variant="outline">Production data</Badge>
          </div>
        </>
      ),
    },
    {
      value: 'Stripe',
      title: 'Stripe variables',
      icon: CreditCard,
      description: (
        <>
          <p>
            Stripe variables power real billing flows, webhook validation, and subscription synchronization.
          </p>

          <div className="mt-4 flex flex-wrap gap-2">
            <Badge variant="outline">STRIPE_SECRET_KEY</Badge>
            <Badge variant="outline">Webhook secret</Badge>
            <Badge variant="outline">Checkout</Badge>
            <Badge variant="outline">Billing workflows</Badge>
          </div>
        </>
      ),
    },
