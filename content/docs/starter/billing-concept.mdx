  ...
  items={[
    {
      ...
      description:
        'Understand the mocked plan, seats, payment method, and billing entry points.',
      icon: CreditCard,
    },
    {
      title: 'Invoice model',
      description:
        'See how invoice history is represented before replacing it with real Stripe data.',
      icon: FileText,
    },
    {
      title: 'Stripe boundary',
      description:
        'Know where Checkout, Portal, webhooks, and subscription sync connect later.',
      icon: ShieldCheck,
    },
  ]}
/>
...
<DocsConceptTabs
  items={[
      ...
      description: (
        <>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Badge variant="outline">Subscription creation</Badge>
            <Badge variant="outline">Backend endpoint</Badge>
            <Badge variant="outline">Payment initiation</Badge>
          </div>
        </>
      ),
    },
      ...
      description: (
        <>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Badge variant="outline">Renewals</Badge>
            <Badge variant="outline">Subscription changes</Badge>
            <Badge variant="outline">Cancellation events</Badge>
          </div>
        </>
      ),
    },
    {
      value: 'Portal',
      title: 'Portal manages customers',
      icon: WalletCards,
      description: (
        <>
          <p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Badge variant="outline">Plan changes</Badge>
            <Badge variant="outline">Cancellation flows</Badge>
          </div>
        </>
      ),
    },
...
<DocsLinks
  ...
  items={[
    ...
    },
    {
      ...
      description:
        'Move from mocked billing UX to production-shaped auth, billing, backend, and delivery foundations.',
      icon: ArrowUpRight,
      badge: 'Pro',
      tone: 'primary',
    },
    {
      title: 'Starter Pro billing',
