  ...
  items={[
    {
      ...
      description:
        'Understand how the codebase is organized before extending product features.',
      icon: FolderTree,
    },
    {
      ...
      description:
        'Learn how authentication is modeled before wiring a real provider.',
      icon: LockKeyhole,
    },
    {
      ...
      description:
        'Understand how monetization is prepared before Stripe integration.',
      icon: CreditCard,
    },
    {
