...
import { default as __fd_glob_24 } from "../content/docs/templates/meta.json?collection=docs";
import { default as __fd_glob_23 } from "../content/docs/starter/meta.json?collection=docs";
import { default as __fd_glob_22 } from "../content/docs/starter-pro/meta.json?collection=docs";
import { default as __fd_glob_21 } from "../content/docs/registry/meta.json?collection=docs";
import { default as __fd_glob_20 } from "../content/docs/project/meta.json?collection=docs";
import { default as __fd_glob_19 } from "../content/docs/patterns/meta.json?collection=docs";
import { default as __fd_glob_18 } from "../content/docs/meta.json?collection=docs";
import { default as __fd_glob_17 } from "../content/docs/guides/meta.json?collection=docs";
import { default as __fd_glob_16 } from "../content/docs/getting-started/meta.json?collection=docs";
import { default as __fd_glob_15 } from "../content/docs/design-system/tokens/meta.json?collection=docs";
import { default as __fd_glob_14 } from "../content/docs/design-system/meta.json?collection=docs";
import { default as __fd_glob_13 } from "../content/docs/blocks/meta.json?collection=docs";
import { default as __fd_glob_12 } from "../content/docs/blocks/feedback/meta.json?collection=docs";
import { default as __fd_glob_11 } from "../content/docs/blocks/data/meta.json?collection=docs";
import { default as __fd_glob_10 } from "../content/docs/blocks/commerce/meta.json?collection=docs";
import { default as __fd_glob_9 } from "../content/docs/blocks/auth/meta.json?collection=docs";
import { default as __fd_glob_8 } from "../content/docs/blocks/app-shells/meta.json?collection=docs";
import { default as __fd_glob_7 } from "../content/docs/blocks/account/meta.json?collection=docs";
import * as __fd_glob_6 from "../content/blog/why-production-migrations-break-saas-products.mdx?collection=blog";
import * as __fd_glob_5 from "../content/blog/why-modern-saas-products-need-better-pwa-foundations.mdx?collection=blog";
import * as __fd_glob_4 from "../content/blog/why-i-stopped-overengineering-saas-starters.mdx?collection=blog";
import * as __fd_glob_3 from "../content/blog/tailwind-node-modules-not-detecting-classes-nextjs.mdx?collection=blog";
import * as __fd_glob_2 from "../content/blog/semantic-design-tokens-tailwind-v4.mdx?collection=blog";
...
export const blog = await create.doc("blog", "content/blog", {
  ...
  "semantic-design-tokens-tailwind-v4.mdx": __fd_glob_2,
  "tailwind-node-modules-not-detecting-classes-nextjs.mdx": __fd_glob_3,
  "why-i-stopped-overengineering-saas-starters.mdx": __fd_glob_4,
  "why-modern-saas-products-need-better-pwa-foundations.mdx": __fd_glob_5,
  "why-production-migrations-break-saas-products.mdx": __fd_glob_6,
});
...
export const docs = await create.docs(
  ...
  "content/docs",
  {
    "blocks/account/meta.json": __fd_glob_7,
    "blocks/app-shells/meta.json": __fd_glob_8,
    "blocks/auth/meta.json": __fd_glob_9,
    "blocks/commerce/meta.json": __fd_glob_10,
    "blocks/data/meta.json": __fd_glob_11,
    "blocks/feedback/meta.json": __fd_glob_12,
    "blocks/meta.json": __fd_glob_13,
    "design-system/meta.json": __fd_glob_14,
    "design-system/tokens/meta.json": __fd_glob_15,
    "getting-started/meta.json": __fd_glob_16,
    "guides/meta.json": __fd_glob_17,
    "meta.json": __fd_glob_18,
    "patterns/meta.json": __fd_glob_19,
    "project/meta.json": __fd_glob_20,
    "registry/meta.json": __fd_glob_21,
    "starter-pro/meta.json": __fd_glob_22,
    "starter/meta.json": __fd_glob_23,
    "templates/meta.json": __fd_glob_24,
    "templates/na-ai-landing/meta.json": __fd_glob_25,
    "ui/meta.json": __fd_glob_26,
  },
  {
