...
const page = readFileSync(
  resolve(marketing, "app/(site)/pricing/page.tsx"),
  "utf8",
);

describe("pricing screenshot assets", () => {
  ...
  it("keeps pricing server-rendered with the existing purchase components", () => {
    ...
    expect(page).toContain('from "@/components/pricing/buy-product-button"');
  });
});
